...
freq = 13
siglen=10
filepath = r'D:\\data\\Tao\\A1-20200128-aaanother\\KQtestwANS100HzOneInput-lockin2\\'
name = 'p8 p7 p4.txt'
...
Inputg=np.linspace(Vg_low, Vg_high, round((Vg_high-Vg_low)/Vg_step)+1)
...
for vbias in Input:
	...
	for Vg in Inputg:
		print('Vg:')
		print(Vg)
		x = 0.02*np.sin(2*np.pi*freq*np.arange(siglen*Fs)/Fs)+Vg
